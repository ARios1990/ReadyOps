      ...
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 sm:px-6">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={signOut} className="rounded-lg bg-slate-900 px-3 py-2 text-sm font-bold text-white">Sign Out</button>
          </div>
        </div>
      </header>
          ...
          <>
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="flex flex-col gap-3 border-b border-slate-100 p-4 sm:flex-row sm:items-center sm:justify-between">
                <div><h2 className="font-bold">Agents</h2><p className="text-xs text-slate-500">Open an agent's private lead portal to review their QC pending, approved and denied leads.</p></div>
