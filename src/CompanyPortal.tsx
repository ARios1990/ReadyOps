...
function StatusChip({ status }: { status: string }) { return <span className={`inline-flex rounded-md border px-3 py-2 text-xs font-black ${leadStatusClasses(status)}`}>{leadStatusLabel(status)}</span>; }
